...
void function(window, document, undefined) {
  ...
  var COLUMN_WIDTH = 300;   // cell width: 190, padding: 14 * 2, border: 1 * 2
...
//		return MIN_COLUMN_COUNT
  ...
  var appendCellsDemo = function (num) {
    ...
    for(var j = 0; j < 10; j++) {
      ...
      cells.push(cell);
      front(cellTemplate, { 'title': 'demo picture ' + key, 'src': key, 'height': "auto", 'width': 300 }, cell);
      fragment.appendChild(cell);
    }
    pageCount++;
